...
@Autonomous(name = "PedroPathingAuto_Test", group = "Examples")
public class PedroPathingAutoSample_Test extends OpMode {
...
//    private final Pose scorePose = new Pose(1, 0, Math.toRadians(0)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
//    private final Pose pickup1Pose = new Pose(0, 0, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
//    private final Pose pickup2Pose = new Pose(0, 0, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark.
//    private final Pose pickup3Pose = new Pose(0, 0, Math.toRadians(0)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    ...
    private final Pose parkPose = new Pose(105, 33, Math.toRadians(90)); // Park Pose at the end of Auto.
