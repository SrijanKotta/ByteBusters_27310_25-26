...
//    private CRServo intakeServo;
    ...
    private final Pose scorePose = new Pose(62, 80, Math.toRadians(130)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose scorePose1 = new Pose(62, 80, Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.

    private final Pose scorePose2 = new Pose(62, 80, Math.toRadians(145)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(43, 80, Math.toRadians(170)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose Collect1_1 = new Pose(34, 80, Math.toRadians(170));
    private final Pose Collect1_2 = new Pose(24, 80, Math.toRadians(170));
...
//    private final Pose Collect1_4 = new Pose(24, 74, Math.toRadians(90));
    private final Pose pickup2Pose = new Pose(43, 60, Math.toRadians(170)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose Collect2_1 = new Pose(39, 60, Math.toRadians(170));
    private final Pose Collect2_2 = new Pose(34, 60, Math.toRadians(170));
    private final Pose Collect2_3 = new Pose(24, 60, Math.toRadians(170));
    private final Pose pickup3Pose = new Pose(43, 36, Math.toRadians(170)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    private final Pose Collect3_1 = new Pose(39, 36, Math.toRadians(170));
    private final Pose Collect3_2 = new Pose(24, 36, Math.toRadians(170));
    private final Pose LeavePose = new Pose(43, 80, Math.toRadians(170)); // Leave Pose at the end of Auto.
...
//            .build();
        ...
        scorePickup2_1 = follower.pathBuilder()
                .addPath(new BezierLine(scorePose1, scorePose2))
                .setLinearHeadingInterpolation(scorePose1.getHeading(), scorePose2.getHeading())
                .build();
